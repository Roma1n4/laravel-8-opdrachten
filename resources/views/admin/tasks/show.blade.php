...
<div class="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden my-4">
        ...
        <div class="py-4 px-6">
            ...
            <p class="py-2 text-lg text-gray-700">{{ $task -> task }}</p>
            <p class="py-2 text-lg text-gray-700">{{ $task -> begindate }} </p>
            <p class="py-2 text-lg text-gray-700">{{ $task -> enddate }} </p>
            <p class="py-2 text-lg text-gray-700">{{ $task -> user -> name }} </p>
            <p class="py-2 text-lg text-gray-700">{{ $task -> project -> name }} </p>
            <p class="py-2 text-lg text-gray-700">{{ $task -> activity -> name }} </p>
            <p class="py-2 text-lg text-gray-700">{{ $task -> created_at }} </p>
        </div>
    </div>
