...
<form id="form" class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
    ...
    <div class="mb-4">
                ...
                name="task" id="task" value="{{ old('task', $task -> task) }}" type="text" disabled>
            </div>
            <div class="mb-4">
                ...
                name="begindate" id="begindate" value="{{ old('begindate', $task -> begindate) }}" type="date" disabled>
            </div>
            <div class="mb-4">
                ...
                name="enddate" id="enddate" value="{{ old('enddate', $task -> enddate) }}" type="date" disabled>
            </div>
            <div class="mb-4">
                ...
                <select 
                    ...
                    name="user_id" id="user_id" value="{{ old('user_id', $task -> user_id) }}" disabled>
            ...
            <div class="mb-4">
                ...
                <select 
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                    focus:outline-none focus:shadow-outline" 
                    name="project_id" id="project_id" value="{{ old('project_id', $task -> project_id) }}" disabled>
            ...
            <div class="mb-4">
                ...
                <select 
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                    focus:outline-none focus:shadow-outline" 
                    name="activity_id" id="activity_id" value="{{ old('activity_id', $task -> activity_id) }}" disabled>
