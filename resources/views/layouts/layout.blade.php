            ...
            <div class="mx-10 my-2">
                ...
                <div class="mt-6 flex justify-between text-gray-600 dark:text-gray-400">
                    ...
                    <div class="ml-10 pl-2 flex capitalize">
                        ...
                        <span class="ml-8 flex items-center">
                            name
                            <svg class="ml-1 h-5 w-5 fill-current text-green-500
							dark:text-green-200" viewBox="0 0 24 24">
				...
				dark:bg-gray-600 shadow-xl rounded-lg cursor-pointer ">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="ml-12 flex flex-col capitalize text-gray-600
						dark:text-gray-400">
                            <span>login</span>
                            <span class="mt-2 text-black dark:text-gray-200">
                                carmen.bel
                    ...
                    <div class="flex">
                        ...
                        <div class="mr-8 flex flex-col capitalize text-gray-600
						dark:text-gray-400">
				...
				dark:bg-gray-600 shadow-xl rounded-lg cursor-pointer">
                    ...
                    <div class="flex justify-between">
                        ...
                        <img class="h-12 w-12 rounded-full object-cover" src="https://appzzang.me/data/editor/1608/f9c387cb6bd7a0b004f975cd92cbe2d9_1471626325_6802.png" alt="" />
				...
				dark:bg-gray-600 shadow-xl rounded-lg cursor-pointer">
                    ...
                    <div class="flex justify-between">
                        ...
                        <img class="h-12 w-12 rounded-full object-cover" src="https://www.hdwallpapers.in/download/2012_darksiders_ii-1920x1080.jpg" alt="" />
                ...
                <div class="mt-8 mb-4 flex px-4 py-4 justify-between bg-white
				dark:bg-gray-600 shadow-xl rounded-lg cursor-pointer">
                    <!-- Card -->
                    ...
                    <div class="flex justify-between">
                        ...
                        <img class="h-12 w-12 rounded-full object-cover" src="https://media.contentapi.ea.com/content/dam/gin/images/2017/01/crysis-3-keyart.jpg.adapt.crop1x1.767p.jpg" alt="" />
