...
<form id="form" class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
    action="<?php echo e(route('tasks.destroy', ['task' => $task -> id])); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>" 
                name="task" id="task" value="<?php echo e(old('task', $task -> task)); ?>" type="text" disabled>
            </div>
            <div class="mb-4">
...
unset($__errorArgs, $__bag); ?>" 
                name="begindate" id="begindate" value="<?php echo e(old('begindate', $task -> begindate)); ?>" type="date" disabled>
            </div>
            <div class="mb-4">
...
unset($__errorArgs, $__bag); ?>" 
                name="enddate" id="enddate" value="<?php echo e(old('enddate', $task -> enddate)); ?>" type="date" disabled>
            </div>
            <div class="mb-4">
                ...
                <select 
                    ...
                    name="user_id" id="user_id" value="<?php echo e(old('user_id', $task -> user_id)); ?>" disabled>
            ...
            <div class="mb-4">
                ...
                <select 
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                    focus:outline-none focus:shadow-outline" 
                    name="project_id" id="project_id" value="<?php echo e(old('project_id', $task -> project_id)); ?>" disabled>
            ...
            <div class="mb-4">
                ...
                <select 
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                    focus:outline-none focus:shadow-outline" 
                    name="activity_id" id="activity_id" value="<?php echo e(old('activity_id', $task -> activity_id)); ?>" disabled>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ryan\Desktop\extra werk\school\laravel8-reupload\resources\views/admin/tasks/delete.blade.php ENDPATH**/ ?>