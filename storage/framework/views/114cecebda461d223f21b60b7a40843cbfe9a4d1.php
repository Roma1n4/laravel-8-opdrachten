...
<form id="form" class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
    action="<?php echo e(route('projects.update', ['project' => $project -> id])); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>" name="name" id="name" value="<?php echo e(old('name', $project -> name)); ?>" type="text">
    </div>
...
unset($__errorArgs, $__bag); ?>" name="description" id="description" value="<?php echo e(old('description', $project -> description)); ?>" type="text">
    </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\school\project school\school\resources\views/admin/projects/edit.blade.php ENDPATH**/ ?>